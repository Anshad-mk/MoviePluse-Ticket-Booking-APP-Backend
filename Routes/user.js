const { register, login, findShow,order,confirmPayment, Movielist,singleMovie,emailauth,findtheater,seatbooking,verifyNumber,searchMovie,seatusage } = require("../Controllers/userControllers");
